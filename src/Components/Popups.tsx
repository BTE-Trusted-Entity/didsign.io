...
export const SignInfoPopup = (props: Toggle) => {
  return (
    <div className=" z-40 text-dark-purple flex fixed max-w-[300px] mx-auto h-[hit] max-h-[360px] bg-silver-blue shadow-2xl rounded-[15px] left-1/2 phone:left-[15%] top-1/4 mt-[3%] -ml-[200px] overflow-y-scroll">
