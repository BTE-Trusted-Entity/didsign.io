...
export function SignBtn() {
  ...
  return (
    <div className="bg-[#ddf0ff80] border-solid border-[#517ca240] border-2 rounded-b-lg mt-0  mx-auto w-[48%] big-phone:w-[80%] flex items-center h-[6rem] justify-center mb-8">
